...
| ls        | Visualizar los archivos en la carpeta o directorio |
| history   | Mostrar el historial de comandos de Bash |
| nano      | Abrir archivos con el programa nano para visualizar su contenido |
...
```
En mi caso, en la carpeta "Home" he creado la carpeta "Bioinfo", en la que iré incluyendo todo el trabajo que vaya llevando a cabo a lo largo de la asignatura. Dentro de esa carpeta, he creado dos nuevos directorios: uno que lleva por nombre "Trabajos", en el que pretendo añadir trabajos que haga fuera del aula, y otro al que he nombrado "Notas", en el que incluiré el trabajo realizado en clase. Dentro de esta última, he dividido los contenidos en "Data", carpeta en la que incluiré información más pesada; "Results", en la que iré añadiendo el trabajo de cada día; y "Doc", en la que, por el momento, he añadido el documento que incluye las referencias de este guión de prácticas. Para organizar mejor el trabajo, dentro de la carpeta "Results" añadiré al inicio de cada sesión una carpeta con la fecha del día, de forma que mi trabajo quede almacenado en orden cronológico y sea más sencillo su posterior seguimiento.
...
2. Lee la ayuda del programa `needle` e intenta ajustar los parámetros
   ...
   Para leer la ayuda de cualquier programa, en la consola introducimos lo siguiente: help()
