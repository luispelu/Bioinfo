...
En mi caso, el nombre de usuario escogido en lugar de mi nombre y apellidos ha sido "luispelu" (juega un poco con ellos).
En cuanto al correo asociado, sí que he empleado el de la universidad, como se recomendaba.
...
Por el momento, he creado e incluido este documento tal cual está indicado en el guión. La idea es, tal y como se nos ha explicado, ir haciendo uso de esta función e ir actualizando este documento con distintos archivos a ignorar.
...
# Notas
Creamos una rama, en mi caso Tronco, en la que vamos a ir metiendo todo. La rama 
principal la llamamos HEAD, y de esa rama podemos ir generando nuevas ramas secundarias
Algo ha dicho de que si queremos hacer algún cambio arriesgado dentro de alguna de 
las ramas, lo ideal es generar una copia en una rama secundaria y hacer los cambios 
ahi, nunca en la rama principal.

nano para abrir archivos de texto desde el terminal: nano (nombre archivo). 
ejemplo: nano .gitignore