...
A mi parecer sí, puesto que se trata de archivos de un tamaño considerable, que pueden interferir en caso de ser añadidos al repositorio.

- ¿Cómo podrías guardar los mensajes de `wget` en un archivo?

Lo hemos hecho al añadir el "-o" tras el wget.

- ¿De cuántas secuencias diferentes se compone este genoma de referencia? 

Se compone de 3, lo he hecho con grep ">" referencia.fa. Con grep "^>" le indicamos el principio de la linea, puesto que sabemos que las secuencias de nucleótidos en este tipo de archivos comienzan con ese signo. Con eso representamos una expresión regular, que es una serie de caracteres que tienen cosas en común
:::
